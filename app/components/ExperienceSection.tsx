...
export default function ExperienceSection() {
  return (
    <section className="flex flex-col gap-6 pt-10">
      ...
      <div className="flex flex-col rounded-lg border border-white/[0.08] bg-white/[0.01] px-4 py-2 transition-colors duration-200 hover:border-white/[0.1] hover:bg-white/[0.02]">
